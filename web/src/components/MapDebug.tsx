...
export const ctrlBtn: CSSProperties = {
  ...
  borderRadius: 3, padding: "1px 6px", cursor: "pointer", fontSize: 11,
};

export const ctrlInput: CSSProperties = {
  width: 55, background: "#333", color: "#fff", border: "1px solid #666",
  borderRadius: 3, padding: "1px 4px", fontSize: 11, textAlign: "center",
};

export interface AdjOffsets {
  x?: number; y?: number; range?: number;
  rotate?: number; mirrorX?: boolean; mirrorY?: boolean;
}
