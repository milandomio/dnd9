...
HARDCODED_LOCALE_OVERRIDES: dict[str, dict[str, str]] = {
    "Accessory_OldRustRoom": {
        "zh-Hans": "旧锈房-饰品",
        "en": "Old Rust Room Accessory",
        "de": "Accessoire des Alten Rostraums",
        "es": "Accesorio de la Sala del Óxido Antiguo",
        "fr": "Accessoire de la salle de la rouille ancienne",
        "ja": "旧錆の部屋のアクセサリー",
        "ko": "낡은 녹 방 장신구",
        "pt-BR": "Acessório da Sala da Ferrugem Antiga",
        "ru": "Аксессуар комнаты Старой Ржавчины",
        "zh-Hant": "舊鏽房-飾品",
    },
    "ArcheryTarget": {
        "zh-Hans": "射箭靶",
    ...
    "ChestLarge_UnderSea": {
        "zh-Hans": "海底大宝箱",
        "en": "Undersea Large Chest",
        "de": "Große Unterwassertruhe",
        "es": "Cofre submarino grande",
        "fr": "Grand coffre sous-marin",
        "ja": "海底の大型宝箱",
        "ko": "해저 대형 보물상자",
        "pt-BR": "Baú grande subaquático",
        "ru": "Подводный большой сундук",
        "zh-Hant": "海底大寶箱",
    },
    "ChestLarge": {
        "zh-Hans": "大宝箱",
    ...
    "ChestMedium_UnderSea": {
        "zh-Hans": "海底中宝箱",
        "en": "Undersea Medium Chest",
        "de": "Mittlere Unterwassertruhe",
        "es": "Cofre submarino mediano",
        "fr": "Coffre sous-marin moyen",
        "ja": "海底の中型宝箱",
        "ko": "해저 중형 보물상자",
        "pt-BR": "Baú médio subaquático",
        "ru": "Подводный средний сундук",
        "zh-Hant": "海底中寶箱",
    },
    "Ground": {
        "zh-Hans": "地面",
    ...
    "SkeletonWoodenBarrel": {
        "zh-Hans": "骷髅木桶",
        "en": "Skeleton Wooden Barrel",
        "de": "Skelett-Holzfass",
        "es": "Barril de madera esquelético",
        "fr": "Tonneau en bois squelette",
        "ja": "スケルトンの木樽",
        "ko": "해골 나무통",
        "pt-BR": "Barril de madeira esqueleto",
        "ru": "Деревянная бочка-скелет",
        "zh-Hant": "骷髏木桶",
    },
