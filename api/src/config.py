...
HARDCODED_TRANSLATIONS = {
    ...
    "CryptSkeletonChampion_Hard": "地穴骷髅冠军（困难）",
    "DemonScout_Hard": "恶魔斥候（困难）",
    "DreadSpine_Hard": "恐惧棘刺（困难）",
    "DwarfHandCannoneer": "矮人火枪手",
    "FrostSkeletonChampion": "冰霜骷髅冠军",
    "FrostSkeletonChampion_Hard": "冰霜骷髅冠军（困难）",
    "FrostStoneOre": "霜石矿",
    "GoblinSkeletonChampion": "哥布林骷髅冠军",
    "GoblinSkeletonChampion_Hard": "哥布林骷髅冠军（困难）",
    "GoldOre": "金矿",
    "InfernoSkeletonChampion": "炼狱骷髅冠军",
    "InfernoSkeletonChampion_Hard": "炼狱骷髅冠军（困难）",
    "InfernoWraith": "炼狱幽魂",
    "InfernoWraith_Hard": "炼狱幽魂（困难）",
    "IronOre": "铁矿",
    "Lifeleaf_HR": "生命之叶",
    "Lumber": "木材",
    "MaelstromSkeletonChampion": "漩涡骷髅冠军",
    "MaelstromSkeletonChampion_Hard": "漩涡骷髅冠军（困难）",
    "MermaidCoffin": "人鱼棺材",
    "MimicLarge": "大宝箱怪",
    "MimicMedium": "中宝箱怪",
    "MimicSmall": "小宝箱怪",
